<x-agent-layout>
    ...
    <x-slot name="headerContent">
        <div class="header-actions">
            <a class="back-btn" href="{{ route('team-leader.dashboard') }}">← Back to Dashboard</a>
        </div>
    </x-slot>
    ...
    <x-slot name="sidebar">
        ...
        <a class="sidebar-icon active" href="{{ route('team-leader.profile') }}" title="My Profile">
    ...
    <div class="profile-container">
        ...
        <div class="grid">
            <div class="card">
                ...
                <form method="POST" action="{{ route('team-leader.profile.update') }}" class="form-edit" id="editForm">
                    @csrf
                    @method('PATCH')
                    <div class="stack">
            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('team-leader.profile.password') }}">
                    @csrf
                    @method('PATCH')
                    <div class="stack">
            ...
            <div class="card">
                ...
                <div class="list">
                    <div>Dark Mode</div>
                    <div><a class="link" href="{{ route('team-leader.dashboard') }}">Back to Dashboard</a></div>
                </div>
            </div>
        </div>
    </div>
