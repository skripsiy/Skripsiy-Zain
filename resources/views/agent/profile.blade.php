            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('agent.profile.update') }}" class="form-edit" id="editForm">
                    ...
                    <div class="stack">
                        ...
                        <input class="input" type="text" name="campaign" placeholder="Campaign"
                            value="{{ old('campaign', Auth::user()->campaign) }}">
                        <input class="input" type="text" name="site" placeholder="Site"
                            value="{{ old('site', Auth::user()->site) }}">
